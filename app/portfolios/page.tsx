      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-6">
          <div className="control flex gap-3 items-center gap-5">
            <p className="bg-white rounded p-2 text-black font-bold hover:opacity-[0.8] cursor-pointer">All</p>
            <p>Featured</p>
          </div>
          <div className="control flex gap-3 items-center gap-5">
            <p>All</p>
      ...
      <div className="mt-8 gap-5 grid grid-cols-3">
        {Array(4)
          ...
          .map((value, index) => (
            <div
              key={index}
              className="border-1 border-solid border-gray-700 p-5 rounded hover:cursor-pointer transition hover:bg-white hover:text-black hover:scale-[1.03]"
            >
              <div className="head">
